...
('LOC_MPT_MODCHECK_BUTTON_NAME', 'zh_Hans_CN', '模组校验'),
('LOC_MPT_MODCHECK_BUTTON_TT', 'zh_Hans_CN', '打开模组校验面板，勾选需要与全房间玩家比对版本的模组（仅房主可用）'),
('LOC_MPT_MODCHECK_RECHECK_NAME', 'zh_Hans_CN', '重新校验'),
('LOC_MPT_MODCHECK_RECHECK_TT', 'zh_Hans_CN', '强制所有玩家重新回报所选模组的版本（仅房主可用）'),
('LOC_MPT_MODCHECK_PANEL_TITLE', 'zh_Hans_CN', '模组校验'),
