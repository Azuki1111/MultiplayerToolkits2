...
-- ============================================================================
INSERT OR REPLACE INTO LocalizedText (Tag, Language, Text) VALUES
('LOC_MPT_FE_VERSION', 'zh_Hans_CN', '2.0.2'),
('LOC_MPT_MOD_ID', 'zh_Hans_CN', '00000000-7369-4685-ab5f-bf77bc22b54e');

INSERT OR REPLACE INTO LocalizedText (Tag, Language, Text)
SELECT 'LOC_MPT_FE_NAME', 'zh_Hans_CN', 'Team PVP Toolkits [COLOR:ResGoldLabelCS]联机工具箱 ' || COALESCE((SELECT Text FROM LocalizedText WHERE Tag = 'LOC_MPT_FE_VERSION' AND Language = 'zh_Hans_CN'), '') || '[ENDCOLOR]';
