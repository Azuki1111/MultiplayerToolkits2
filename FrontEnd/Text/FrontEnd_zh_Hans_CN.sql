...
-- 条目36扩展：ESC 菜单订阅按钮（游戏内消费，InGameTopOptionsMenu_MPT.lua；LOC_MPT_MOD_ID 反推本 mod 订阅 ID 后跳转）
('LOC_MPT_SUBSCRIBE_NAME', 'zh_Hans_CN', '订阅联机工具箱'),
('LOC_MPT_SUBSCRIBE_TOOLTIP', 'zh_Hans_CN', '打开创意工坊页面，订阅以自动更新');
