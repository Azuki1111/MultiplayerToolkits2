...
('LOC_MPT_PLAYERMARK_DELETE_TT', 'zh_Hans_CN', '永久删除该玩家的全部记录'),
('LOC_MPT_PLAYERMARK_ADD_DETAIL', 'zh_Hans_CN', '添加'),
('LOC_MPT_PLAYERMARK_DETAIL_INPUT_TT', 'zh_Hans_CN', '输入一条新的详细描述，回车或点击「添加」'),
('LOC_MPT_PLAYERMARK_DETAIL_DELETE_TT', 'zh_Hans_CN', '删除本条详细描述'),
-- 标签三选一按钮提示
('LOC_MPT_PLAYERMARK_TAG_FRIEND_TT', 'zh_Hans_CN', '标记为好友'),
('LOC_MPT_PLAYERMARK_TAG_NORMAL_TT', 'zh_Hans_CN', '标记为一般'),
('LOC_MPT_PLAYERMARK_TAG_BLACK_TT', 'zh_Hans_CN', '标记为黑名单'),
-- 空态提示
