...
VALUES
	...
	('LOC_MPT_HASHCHECK_DESC',			'en_US',	'Checks that every player runs identical files in multiplayer games (mod integrity anti-cheat). Results are shown in the in-game Quick Actions panel. Enable on all players; mutually exclusive with other GameCore-hooking mods.'),
	...
	('LOC_MPT_HASHCHECK_STATUS_UNKNOWN',		'en_US',	'Waiting...'),
