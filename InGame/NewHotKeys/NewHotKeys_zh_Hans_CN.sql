...
VALUES
	...
	('LOC_TURNTIME_FORCED_TURNEND_NAME',					'zh_Hans_CN',	'[COLOR:ResGoldLabelCS]自动强制结束回合[ENDCOLOR]'),
	('LOC_MPT_NHK_FORCE_END_ONCE_NAME',						'zh_Hans_CN',	'[COLOR:ResGoldLabelCS]强制结束回合[ENDCOLOR]'),
	('LOC_MPT_NHK_FORCE_END_ONCE_DESC',						'zh_Hans_CN',	'立即强制结束本回合，无视未完成行动（等同强制结束按钮左键）'),
	('LOC_TURNTIME_FORCED_TURNEND_DESCRIPTION',				'zh_Hans_CN',	'切换自动强制结束模式：立即结束回合并进入自动模式，此后每回合自动结束，再按一次取消'),
