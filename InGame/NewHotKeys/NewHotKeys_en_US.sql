...
VALUES
	...
	('LOC_TURNTIME_FORCED_TURNEND_NAME',					'en_US',	'[COLOR:ResGoldLabelCS]Auto Force End Turn[ENDCOLOR]'),
	('LOC_MPT_NHK_FORCE_END_ONCE_NAME',						'en_US',	'[COLOR:ResGoldLabelCS]Force End Turn[ENDCOLOR]'),
	('LOC_MPT_NHK_FORCE_END_ONCE_DESC',						'en_US',	'Immediately force-end the current turn, ignoring unfinished actions (same as the Force End button left-click)'),
